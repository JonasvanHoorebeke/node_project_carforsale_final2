...
router.get('/annonce/add', annonceController.annonceNew);

router.post('/annonce/save', annonceController.SkinSave);

router.get('/skin/edit/:userId', annonceController.SkinEdit);
