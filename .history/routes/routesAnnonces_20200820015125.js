...
router.post('/api/annonce/add', annonceControllersApi.SkinSaveApi); //ok

router.put('/api/skin', annonceControllersApi.updateSkinApi); //ok

router.get('/api/skin/:userId', annonceControllersApi.SkinEditApi); //ok

router.delete('/api/skin/:userId', annonceControllersApi.SkinDeleteApi); //ok
