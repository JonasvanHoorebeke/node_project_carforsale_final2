...
router.post('/api/signup', loginControllerApi.signup); 

router.get('/api/login', loginControllerApi.login);  

router.get('/api/profil/update/:userId', loginControllerApi.profilUpdate); 

router.put('/api/profil/update/', loginControllerApi.updateProfil); 
