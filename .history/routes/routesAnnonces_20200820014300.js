...
router.get('/annonce/edit/:id', annonceController.annonceEdit);

router.post('/annonce/update', annonceController.annonceUpdate);

router.get('/annonce/delete/:id', annonceController.annonceDelete);

router.get('/annonce/get/:id', annonceController.annonce);
